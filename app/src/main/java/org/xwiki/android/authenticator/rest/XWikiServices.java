...
public abstract class XWikiServices {

    @POST("bin/login/XWiki/XWikiLogin")
    public abstract Observable<Response<ResponseBody>> login(@Header("Authorization") String basicAuth);
    ...
    public Observable<Response<ResponseBody>> login(String username, String password) {
        return login(Credentials.basic(username, password));
    }
